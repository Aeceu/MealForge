import { View, Text, TextInput, TextProps, TouchableOpacity, Image } from 'react-native'
  ...
  return (
    <View className='w-full space-y-1'>
      ...
      <View className="flex-row items-center w-full border rounded-lg shadow-sm h-14 border-gray focus:border-main focus:border">
        <TextInput
          className={`flex-1 h-full px-5 text-base ${colorScheme === "light" ? "text-dark" : "text-light"}`}
          placeholder={title}
        ...
        <View className={`absolute w-full h-full rounded-lg -z-10
